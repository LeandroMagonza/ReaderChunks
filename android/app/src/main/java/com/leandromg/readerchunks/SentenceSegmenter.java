...
public class SentenceSegmenter {
    ...
    public static List<String> segmentIntoSentences(String text) {
        ...
        // Split by double line breaks (empty lines that separate paragraphs)
        ...
        for (String block : blocks) {
            ...
            // Add the complete paragraph as a single line
            // No punctuation processing - preserve text exactly as it is
